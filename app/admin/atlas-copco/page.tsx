// /app/admin/atlas-copco/page.tsx (or page.js)
...
export default function AtlasCopcoPage() {
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">Atlas Copco Products</h1>
        <Link
          href="/admin/products?company=atlas-copco"
